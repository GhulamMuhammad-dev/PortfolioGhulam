        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-4 text-brand-sub-text">
              <a href="https://linkedin.com" className="hover:text-brand-dark-text transition-colors">
                <LinkedInIcon className="w-5 h-5" />
              </a>
              <a href="https://x.com" className="hover:text-brand-dark-text transition-colors">
                <XIcon className="w-5 h-5" />
              </a>
              <a href="https://github.com" className="hover:text-brand-dark-text transition-colors">
