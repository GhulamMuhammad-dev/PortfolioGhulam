      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {projects.map((proj) => (
          <div key={proj.id} className="project-card group cursor-pointer flex flex-col items-start">
            ...
            <div className="relative aspect-video w-full overflow-hidden rounded-xl border-2 border-brand-dark-text bg-gray-100 transition-all duration-300 group-hover:shadow-[8px_8px_0px_0px_rgba(13,13,13,1)] group-hover:-translate-y-1">
              <Image 
                src={proj.img} 
                alt={proj.title} 
                fill 
